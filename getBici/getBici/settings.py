"""
Django settings for getBici project.
...
SECRET_KEY = 'v!82b*i+$wk+nit#e#2x2%(#0lk(i(h+=04xedf!!aaj+8apu0'
...
SHARED_APPS = (
    ...
    'public',  # you must list the app where your tenant model resides in
